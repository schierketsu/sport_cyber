...
class _SessionsChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalHeight = sessions.length * (barHeight + 4) + labelHeight + spacingS;
        ...
        SizedBox(
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              return Stack(
                children: [
                  _TimeGrid(width: width, height: totalHeight - labelHeight),
                  ...List.generate(sessions.length, (i) {
                    final s = sessions[i];
                    final y = labelHeight + i * (barHeight + 4);
